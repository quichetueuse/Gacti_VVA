...
final class FunctionController extends BaseController
{
    ...
    public function generateHeaderDiv(bool $is_user_connected = false) : string
    {
        ...
        $header_div = '
                <div class="header-div" style="border: 1px solid black; justify-content: space-between">
                    <div class="flex-column-center" style="border: 1px solid blue;">
                        <!-- session info div-->
                        <div>
                    ...
                    <h1 style="height: 100%; display: flex; align-items: center; justify-content: center;">VVA</h1>
            ';
        ...
        if ($is_user_connected === true)
        {
            $header_div .= '
                ...
                <div class="flex-center" style="border: 1px solid blue;">
...
//        }
    ...
    public function generateAnimsControlDiv() : string {
        ...
        foreach ($anim_list as $anim) {
            $div .= '<option title="'. $anim["COMMENTANIM"] .'" value="' . $anim["CODEANIM"] . '">' . $anim['NOMANIM'] . ' | ' . $anim['DESCRIPTANIM'] . '</option>'; //todo optimiser requêtes (fonction prenant en paramettre les champs à prendre)
        }
